...
<html>
   ...
   <body id="color">
      ...
      <h1 class="title-projet1">Projet 3: Site Rocket league</h1>
      <div class="row">
         <div class="col image s12 m3 offset-m2">
            <img class="dasri2" src="../Projet 2 Materialized/img/rl2.png">
         </div>
         <div class="col text s12 m3 offset-m2">
            <p> Description du projet global</p>
            <p>Durant notre premier projet de notre année au Gaming Campus nous avons du créé un site sur notre jeu favoris. Pour notre part ce fut le jeu Rocket League. Durant ce projet nous avons vue toute les bases d’un site HTML mais aussi les base d’un style avec le CSS. Nous avons donc stylisé notre propre site avant de passer en partielle le vendredi devant notre professeur qui nous as suivis tout la semaine.  </p>
         </div>
      </div>
