...
<html>
   ...
   <body id="color">
      ...
      <h1 class="title-projet1">Projet 1: DASRI</h1>
      <div class="row">
         <div class="col image s12 m3 offset-m2">
            <img class="dasri2" src="../Projet 2 Materialized/img/dasri2.png">
         </div>
         <div class="col text s12 m3 offset-m2">
            <p> Description du projet global</p>
            <p>Durant mon année de terminal STI2D, j’ai eu la chance d’effectuer plusieurs projet en groupe, je vais donc parler du plus gros projet que j’ai effectuer ( qui ma servie de support pour le grand orale), les Dasri. Durant ce projet j’ai travailler principalement sur la sécurisation de ces derniers. Je me suis occuper de sécuriser l’ouverture du bac mais aussi de la sécurisation au niveau de la récupération de ces déchets. Pour la partie sécurisation du bac, j’ai eu de nombreuse idée malgré les contraintes suivante : respecter les geste (période COVID-19), facile d’utilisation et rapide.
               Pour cela, j’ai retenue la solution des empreintes digital facile d’accès, non encombrant, … Suite a cela j’ai du coder les modules adéquats pour faire fonctionner mon projet. 
            </p>
         </div>
      </div>
